...
const AuthForm = ({
  ...
  const Wrapper = variant === "modal" ? ModalWrapper : PageWrapper;
  ...
  return (
    <Wrapper onClose={onClose}>
      ...
      {info && (
        <div className="text-gray-500 text-sm mb-6 text-center">{info}</div>
      )}

      <form className="space-y-4" onSubmit={handleSubmit}>
        <div>
          <label
            htmlFor={variant === "modal" ? "modal-email" : "email"}
        ...
        <div>
          <label
            htmlFor={variant === "modal" ? "modal-password" : "password"}
            className="block text-sm font-medium text-gray-700 mb-1"
          >
            Password
          </label>
